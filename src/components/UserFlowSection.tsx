  ...
  return (
    <section id="design" className="py-24 px-6 md:px-12 lg:px-24 bg-surface">
      <div className="max-w-6xl mx-auto">
        ...
        >
          <span className="text-accent font-medium tracking-wide uppercase text-sm">{t('userflow.label')}</span>
          <h2 className="font-display text-3xl md:text-4xl lg:text-5xl font-semibold mt-3 mb-6">{t('userflow.title')}</h2>
          <p className="text-body text-lg max-w-2xl mx-auto leading-relaxed">{t('userflow.description')}</p>
        </div>
